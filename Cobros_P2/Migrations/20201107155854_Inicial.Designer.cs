...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cobros_P2.Models.Clientes", b =>
                {
            ...
            modelBuilder.Entity("Cobros_P2.Models.Cobros", b =>
                {
            ...
            modelBuilder.Entity("Cobros_P2.Models.CobrosDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Cobros_P2.Models.Ventas", b =>
                {
                    b.Property<int>("VentaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Cobros_P2.Models.CobrosDetalle", b =>
                {
                    b.HasOne("Cobros_P2.Models.Cobros", "Cobro")
                        .WithMany("Detalle")
                        .HasForeignKey("CobroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cobros_P2.Models.Ventas", "Venta")
                        .WithMany("Detalle")
            ...
            modelBuilder.Entity("Cobros_P2.Models.Ventas", b =>
                {
                    b.HasOne("Cobros_P2.Models.Clientes", "Cliente")
                        .WithMany("venta")
